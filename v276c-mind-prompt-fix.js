...
(function v276c() {
  ...
  // 列挙ではなく具体例で「こういう肌触りで」と示す。
  // 列挙すると Hermes はその枠内に逃げ込むが、例 1 つだけだと幅が出る。
  var SCHEMA_EXAMPLE =
    '【出力例 (この外形を厳密に守る — 値の中身は自由に展開してよい)】\n' +
    '{\n' +
    '  "リナ": "右目が冷たい。痛みがまだ来ない——脳が追いついていない。鉄臭さだけが鮮明で、' +
    'なぜか『お母さん』と呟きそうになる。声を出そうとするが息が浅すぎて言葉にならない。",\n' +
    '  "スピカ": "罪悪感が喉元まで上がってきている。だが今手を止めれば全員死ぬ、' +
    'と判じる別の自分がいる。指先だけが冷たい。"\n' +
    '}';
