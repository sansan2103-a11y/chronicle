...
//   敷くことで底上げする。全モデル（Euryale/Hermes 等）に効く下地を system に注入する。
// 設計（おしんと合意）: からだ/こころ/本能 の3軸＋人間の文法3本＋反応の焦点＋一貫性。
// 更新(実機フィードバック反映): 眼球ターンで「傷を負った当事者の苦痛より傍観者の反応が前に出る」
//   傾向が見えたため【反応の焦点（最優先）】を追加。当事者本人の痛みを最優先・最濃で描かせる。
