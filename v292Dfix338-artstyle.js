...
(function(){
  ...
  var LEGACY_PREFIX = [ART6_OLD, ART6C_OLD, ART6_V1, ART6C_V1, ART6_V2, ART6C_V2, ART6_V3, ART6C_V3, ART6_V4, ART6C_V4, ART6_NEW, ART6C_NEW];   // ★fix434: fix433版(V4)も剥がし対象に追加   // ★fix433: fix432版(V3)も剥がし対象に追加   // ★fix432: fix431版(V2)も剥がし対象に追加   // ★fix431: fix429版(V1)も剥がし対象に追加（二重前置の防止）
  function apply429(){
    var o = off429();
