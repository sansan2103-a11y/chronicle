...
(function(){
  ...
  var LABELS=['アニメ','リアル','水彩','ダーク','SF','リアルアニメ','ダークアニメ','ダークアニメ旧'];
  var STYLE_TITLE='AIアイコンの絵柄。アニメ=明るいセル / リアル=暖色の写実 / 水彩=淡く優しい / '
    +'ダーク=退色ゴシック(怪異・ダークファンタジー向き) / SF=寒色シネマティック / リアルアニメ=柔らかい半実写アニメ(なめらか肌・くすんだ自然色) / ダークアニメ=暗く儚い半実写アニメ(青白い肌・退色・ゴシック寄り) / ダークアニメ旧=初期の暗い半実写アニメ(旧レシピ・キャラの外見を最優先)。'
