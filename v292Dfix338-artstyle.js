...
(function(){
  ...
  var ART6C_NEW = 'JRPG creature concept art, game bestiary portrait, soft semi-realistic rendering, clean lineless digital painting, luminous surfaces with subtle sheen, fine individual detail, soft dim ambient lighting, muted desaturated color grading, dark grey gradient background, three-quarter view angled to the side, upper body bust framing with space around, not a close-up, highly detailed, high quality, non-human creature, monster design, no human face';
  var LBL6_NEW  = 'デフォルト';
  var TITLE_NEW = TITLE_OLD.replace('闇アニメ=青白い肌の暗い半実写アニメ', 'デフォルト=明るく柔らかい半写実アニメ');
  // 新旧どちらが有効でも、もう片方は「剥がすべき自前PREFIX」として残す(冪等化)
  var LEGACY_PREFIX = [ART6_OLD, ART6C_OLD, ART6_V1, ART6C_V1, ART6_V2, ART6C_V2, ART6_NEW, ART6C_NEW];   // ★fix432: fix431版(V2)も剥がし対象に追加   // ★fix431: fix429版(V1)も剥がし対象に追加（二重前置の防止）
  function apply429(){
    var o = off429();
