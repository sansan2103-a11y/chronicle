    ...
    if (path === '/image') {
      ...
      if (tgKey) {
        try {
          ...
          try { dbg19.sent = { model: tgBody.model, steps: tgBody.steps, width: tgBody.width, height: tgBody.height, has_image_loras: !!tgBody.image_loras, image_loras: tgBody.image_loras || null, seed: tgBody.seed != null ? tgBody.seed : null, response_format: tgBody.response_format }; } catch (e19) {}
