...
(function v292Dfix105(){
  ...
  var BLOCK = [
    ...
    '・文学的な描写の濃さ（Show Don\'t Tell・五感・心理）は保つ。ただし描写を重ねることが目的化して話が止まらないように。「濃いまま止まらず前へ」。',
    '',
    '【場にいる者は“生きている”】',
    ...
    '',
    '【一読で伝わる具体描写（厳守）】',
    '・文学性とは凝った言い回しでなく「一読で情景が浮かぶこと」。読み返さないと意味が取れない文・不自然な言い回しは詩的でも失敗。比喩や美文より「誰に何が起きたか」の具体と物理的な筋を優先し、明晰さを優先する（短くても筋が通って具体的なら良い）。',
    '・物理的に破綻させない（無生物が泣く/血を流す、位置・人物・負傷・痛みの主体が前ターンと食い違う等）。位置・負傷・所持・誰の行動かは前ターンと一貫させる。',
    '・主語と述語が実際に噛み合う組合せに。「月光が瞼を貫く」「冷気が瞼からこぼれる」「空気が鼓膜を伝って耳底に染み渡る」のような物理的に起きない主語-動詞や、無理な使役/受身（浮き上がらせて/湧き上げさせる）を避け、主語が普通にする動詞で書く（浮かぶ/差す/震える/開く）。',
    '・各文は述語で言い切る（連用形・て止めの断片で終えない）。一文に節や比喩を詰め込みすぎず原則1文1情報。凝るより通じるを優先する。',
    '・何が起きたか・誰がどうしたかは読んで明確に分かるよう保つ。抽象的で思わせぶりなだけの内心で埋めない。',
    '',
    '【出力の鉄則】',
