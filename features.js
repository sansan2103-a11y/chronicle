          ...
          if (r.sys.indexOf('【反復の禁止') < 0){
            ...
            try {
              ...
              if (/続きを(?:自然に)?進めて/.test(_pt138) || /^続きを書/.test(_pt138)){
                ...
                _drama = '【続きを書く＝物語を"横"に広げる】前ターンを引き継いだ上で、状況を次の段階へ動かす。重要な原則："縦"（同じ行為・同じ被害の強度を上げる＝グロや痛みを激しくするだけ）は前進ではない。"横"＝【新しい要素を必ず1つ持ち込む】こと：新キャラや存在の登場／場所の移動・転換／脱出や追跡／時間経過／重要な事実・謎の発覚／力関係や関係性の変化／思いがけない選択肢や申し出。毎ターン、このどれか1つで世界を広げる。主人公は受け身の観察に留めず、状況に応じて自分から動く（抵抗・逃走・対峙・利用・取引・救出・探索・呼びかけ等。冷静なキャラなら計算ずくの選択として）。同じ被害描写の反復で終えない。';
