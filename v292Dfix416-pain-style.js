...
(function(){
  ...
  // ---- 注入文 ---------------------------------------------------------
  var PAIN_MARK = '【痛覚】';
  var PAIN_TEXT = '\n【痛覚】直前に重傷(骨折・断裂・切断・深い裂傷・大量出血・貫通)を負った者の描写では、まず生理的な発声(悲鳴・絶叫・うめき・かすれた叫び)を第一候補として描く。声が出ないのは凍結・解離・気道損傷など理由がある場合だけで、その時は痙攣する喉・過呼吸・声にならない息など理由が伝わる身体徴候を具体的に描く。冷静な観察や無反応で流さない。以後2〜3ターンは痛みを行動と台詞の合間に滲ませ続ける。';
  var STYLE_MARK = '【文体】';
