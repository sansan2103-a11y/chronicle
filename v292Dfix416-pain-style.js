...
(function(){
  ...
  // ---- 注入文 ---------------------------------------------------------
  var PAIN_MARK = '【痛覚】';
  var PAIN_TEXT = '\n【痛覚・最優先】直前に重傷(骨折・断裂・切断・深い裂傷・大量出血・貫通)を負った当人は、その瞬間に実際の叫び(「ぎゃああっ」「あ゛あっ……！」「いっ……ぁあああ！」等の音)を<say>の1行として必ず出す。声を出さないことが許されるのは、既に確立した無口・解離的な人格か、気道や肺の損傷など明示的な理由がある場合だけ。その場合も痙攣する喉・過呼吸・声にならない息を具体的に描く。以後2〜3ターンは痛みのうめき・浅い呼吸・かばう動作を台詞と行動に滲ませ続ける。';
  var STYLE_MARK = '【文体】';
