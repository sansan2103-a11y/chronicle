/* v122: widen vocative ("name。") + postfix verb with phrases between */
(function v122(){
  'use strict';
  var TAG = '[v122]';
  if (window.__v122Active) return;
  window.__v122Active = true;
  ...
  function attributeDialogue(narr, pos, dlgText, defSpk, heroName, npcs){
    ...
    /* 1b. Postfix WIDE: 「..」と<name>... <verb>  OR  「..」<name>は ... <verb> */
    var after = narr.slice(pos + dlgText.length + 2, pos + dlgText.length + 200);
    /* Allow up to 30 chars between name and verb */
  ...
  console.log(TAG, 'v122 active: wider vocative + postfix verb');
})();
